...
<br>
<div class="container">
	<h1>CADASTRO DE FOTOS DO ALBUM</h1>
	<br>
	<br>
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_album" action="http://oniemariaproducoes.com/adm/model/fotos_album.php" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							...
							<select chave="id" valor="nome" modelo="album" class="form-control selectAjax" id="inlineFormInputGroupalbum" placeholder="Album" name="id_album">
								<option value=""></option>
							<select>
							<div class="input-group-append">								
						...
						<div class="input-group mb-3">
							...
							<input class="form-control" id="inlineFormInputGroupfoto" placeholder="Foto do album" name="foto[]" type="file" multiple accept="image/jpeg">
							<div class="input-group-append">								
