...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_album" action="http://oniemariaproducoes.com/adm/model/album.php">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							<label class="sr-only" for="inlineFormInputGroupmenu">menu</label>
							<div class="input-group-prepend">
								<div class="input-group-text">
									<i class="fa fa-link" aria-hidden="true"></i>
								</div>
							</div>
							<select chave="id" valor="nome" modelo="menu" class="form-control selectAjax" id="inlineFormInputGroupmenu" placeholder="Menu" name="id_menu">
								<option value=""></option>
							<select>
							<div class="input-group-append">								
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" id="inlineFormInputGroupnome" placeholder="Nome do album" name="nome">
							<div class="input-group-append">								
