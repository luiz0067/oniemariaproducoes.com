<?php include 'top.php'?>
		<div class="row" style="padding: 0 0 0 0;margin: 0 0 0 0; width:100%;min-height:100%;height:auto">			
			...
			<div class="col-sm-9" style="margin: 0 0 0 0;padding: 0 0 0 0; background:white;">	
				...
				<h3 class="text-center" style="color:#b81d1d;"><?php echo $_GET["nome_menu"]?></h3>
				<div class="row" style="height:50px;"></div>
				<div class="col-12">
...
?>
								<a href="/galeria/<?php echo $_GET["nome_menu"]?>/<?php echo $resultado['nome_album']?>"><div class="galleryItem card">
								    <label style="color:#b81d1d;text-transform: uppercase;">&nbsp;<?php echo $resultado['nome_album']?></label>
									<img class="card-img-top" src="/uploads/album/1366x768/<?php echo $resultado['foto']?>" data-text="<?php echo $resultado['nome_album']?>">
								</div></a>
<?php 	
									$contador++;
								}
